...
<asp:Content ContentPlaceHolderID="pageTiltleHolder" runat="server">
 ...
 <form id="form1" runat="server">
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PPPConnectionString %>" DeleteCommand="DELETE FROM [Employes] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Employes] ([login], [password]) VALUES (@login, @password)" SelectCommand="SELECT [login], [password], [Id] FROM [Employes] WHERE ([login] = @login)" UpdateCommand="UPDATE [Employes] SET [login] = @login, [password] = @password WHERE [Id] = @Id">
         <DeleteParameters>
