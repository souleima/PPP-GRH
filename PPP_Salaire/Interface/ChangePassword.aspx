...
<asp:Content ContentPlaceHolderID="pageTiltleHolder" runat="server">
 ...
 <form id="form1" runat="server">
     ...
     <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" DefaultMode="Edit" DataKeyNames="Id">
         <EditItemTemplate>
             login:
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PPPConnectionString %>" SelectCommand="SELECT [login], [password], [Id] FROM [Employes] WHERE ([login] = @login)" DeleteCommand="DELETE FROM [Employes] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Employes] ([login], [password]) VALUES (@login, @password)" UpdateCommand="UPDATE [Employes] SET [login] = @login, [password] = @password WHERE [Id] = @Id">
         <DeleteParameters>
