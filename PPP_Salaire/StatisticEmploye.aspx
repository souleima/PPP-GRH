    ...
    <form id="form1" runat="server">
        ...
        <table style="border:1px solid black; font-family:Arial">
                ...
                <tr>
                    <td colspan="2">
                         <br />
                         <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource2" Height="549px" Width="691px">
                             <series>
                         ...
                         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PPPConnectionString %>" ></asp:SqlDataSource>
                    </td>
                </tr>
            </table>            
